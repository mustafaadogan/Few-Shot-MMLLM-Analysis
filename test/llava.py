...
class LLaVA:
    ...
    def test(self, data):
        """
        Test the LLaVA model on the given data.
        ...
        for item in tqdm(data):
            ...
            prompt = f"<|im_start|>system\n{item['query_prompt']}<|im_end|>"

            if is_caption_query:
                prompt += f"<|im_start|>user\n<image>\n{item['query_prompt']} {query_caption} Answer:<|im_end|><|im_start|>assistant\n"
            else:
                prompt += f"<|im_start|>user\n<image>\n{item['query_prompt']} {query_foil} Answer:<|im_end|><|im_start|>assistant\n"
